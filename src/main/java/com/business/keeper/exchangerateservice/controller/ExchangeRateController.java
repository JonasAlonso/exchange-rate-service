...
import com.business.keeper.exchangerateservice.model.ExchangeRateResult;
...
public class ExchangeRateController {
    ...
    public ExchangeRateResult getExchangeRateForGivenDateAndCurrencies(@PathVariable String date, @PathVariable Currency baseCurrency, @PathVariable Currency targetCurrency){
